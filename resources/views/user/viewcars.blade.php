                    ...
                    <div class="col-lg-8 d-none d-xl-block">
                        <nav class="mainmenu alignright">
                            <ul>
                                ...
                                <li class="active"><a href="{{ url('user/viewcars') }}">Cars</a></li>
          ...
          @endif
                        ...
                        <div class="single-car-wrap">
                            <div class="row">
                                ...
                                <div class="col-lg-5">
                                    <a href="{{ url('user/car/fulldescription/'.$c['id']) }}"><img style="height: 220px; margin:5px" src = "{{ URL::to('/').'/uploads/'.$c['image'] }}"></a>
                                </div>
                                <!-- Single Car Thumbnail -->
